...
function Recipe_Dinner_1(props) {
    ...
    return (
        ...
        <div>
            ...
            <div className="Container">
                ...
                <DelayLink delay={2000} to="./Recipe_Dinner_1_1" replace={false}><div className="Button" onClick={() => {setIsShow(true); setTimeout(() => {setIsShow(false);},1500)}}> Старт </div></DelayLink>
...
export default Recipe_Dinner_1
