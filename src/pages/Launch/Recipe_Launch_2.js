...
function Recipe_Launch_2(props) {
    ...
    return (
        ...
        <div>
            ...
            <div className="Container">
                ...
                <DelayLink delay={2000} to="./Recipe_Launch_2_1" replace={false}><div className="Button" onClick={() => {setIsShow(true); setTimeout(() => {setIsShow(false);},1500)}}> Старт </div></DelayLink>
...
export default Recipe_Launch_2
