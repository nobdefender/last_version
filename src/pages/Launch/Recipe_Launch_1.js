...
function Recipe_Launch_1(props) {
    ...
    let ImageBack1 = {
        backgroundImage: "url(" + props.photo_recipe_launch_first_1 + ")"
    };
    return (
        ...
        <div>
            ...
            <div className="Container">
                ...
                <div class="IngredientsBox">
                    ...
                    <div className="IngrGrid">
                        <div className={classes.container}>
                            ...
                            <div style={{ gridColumnEnd: "span 6" }}>
                                <div className="Bold"> • </div><div className="nPr"> {props.ingredients_11}</div>
                            </div>
                            <div style={{ gridColumnEnd: "span 6" }}>
                                <div className="Bold"> • </div><div className="nPr"> {props.ingredients_12}</div>
                            </div>
                            <div style={{ gridColumnEnd: "span 6" }}>
                                <div className="Bold"> • </div><div className="nPr"> {props.ingredients_13}</div>
                            </div>
                        </div>
                ...
                <DelayLink delay={2000} to="./Recipe_Launch_1_1" replace={false}><div className="Button" onClick={() => {setIsShow(true); setTimeout(() => {setIsShow(false);},1500)}}> Старт </div></DelayLink>
...
export default Recipe_Launch_1
