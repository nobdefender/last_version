...
function Recipe_Launch_2_1(props) {
    const classes = useStyle();

    let ImageBack1 = {
        backgroundImage: "url(" + props.photo_recipe_launch_second_1 + ")"
    };
    ...
    return (
        <div>
            ...
            <div className="Container">
                ...
                <DelayLink delay={2000} to="./Recipe_Launch_2_2" replace={false}><div className="Button" onClick={() => {setIsShow(true); setTimeout(() => {setIsShow(false);},1500)}}> Продолжить </div></DelayLink>
...
export default Recipe_Launch_2_1;
